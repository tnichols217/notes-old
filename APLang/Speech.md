...
Open source code also promotes good coding procedures, like using code wisely and make it work well. If no one ever sees the code, such as in a proprietary manner like Mac, once something works it will likely never get looked at again or made better, since the coders are met
%%
