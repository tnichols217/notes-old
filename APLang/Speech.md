...
Portability simply means that something can be taken from something and put into another. More practically, it means that everything works in a more modular type approach.
%%
