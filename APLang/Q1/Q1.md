		...
		- !!!col
			- 1
				...
				**0 points**
				...
				- The intended thesis only restates the prompt. • The intended thesis provides a summary of the issue with no apparent or coherent claim. • There is a thesis, but it does not respond to the prompt.
				```
			- 1
