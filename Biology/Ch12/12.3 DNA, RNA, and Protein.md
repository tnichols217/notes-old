...
3. the rRNA in the ribosome **catalyses the two tRNAs to join the amino acids** together with **peptide bonds** into a string, moving the amino acid string from the tRNA in 
